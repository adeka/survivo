...
Survivo-Linux-Debug:
	 $(PROJECTBUILD) Survivo Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survivo-Linux-DebugGame:
	 $(PROJECTBUILD) Survivo Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survivo-Linux-Shipping:
	 $(PROJECTBUILD) Survivo Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survivo-Linux-Test:
	 $(PROJECTBUILD) Survivo Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Survivo:
	 $(PROJECTBUILD) Survivo Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurvivoEditor-Linux-Debug:
	 $(PROJECTBUILD) SurvivoEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurvivoEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SurvivoEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurvivoEditor-Linux-Shipping:
	 $(PROJECTBUILD) SurvivoEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurvivoEditor-Linux-Test:
	 $(PROJECTBUILD) SurvivoEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SurvivoEditor:
	 $(PROJECTBUILD) SurvivoEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
