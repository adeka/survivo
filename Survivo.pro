...
unrealRootPath=/home/snuc/workspace/unreal-engine/UnrealEngine-4.17
SurvivoRootPath=/home/snuc/workspace/unreal-engine/survivo

gameProjectFile=/home/snuc/workspace/unreal-engine/survivo/Survivo.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(SurvivoSource.pri)
include(SurvivoHeader.pri)
include(SurvivoConfig.pri)
include(SurvivoIncludes.pri)
include(SurvivoDefines.pri)
...
Survivo-Linux-Debug.commands = $$build Survivo Linux Debug  -project="\"$$gameProjectFile\"" $$args
Survivo-Linux-DebugGame.commands = $$build Survivo Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Survivo-Linux-Shipping.commands = $$build Survivo Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Survivo-Linux-Test.commands = $$build Survivo Linux Test  -project="\"$$gameProjectFile\"" $$args
Survivo.commands = $$build Survivo Linux Development  -project="\"$$gameProjectFile\"" $$args

SurvivoEditor-Linux-Debug.commands = $$build SurvivoEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
SurvivoEditor-Linux-DebugGame.commands = $$build SurvivoEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SurvivoEditor-Linux-Shipping.commands = $$build SurvivoEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SurvivoEditor-Linux-Test.commands = $$build SurvivoEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
SurvivoEditor.commands = $$build SurvivoEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Survivo-Linux-Debug \
	Survivo-Linux-DebugGame \
	Survivo-Linux-Shipping \
	Survivo-Linux-Test \
	Survivo \
	SurvivoEditor-Linux-Debug \
	SurvivoEditor-Linux-DebugGame \
	SurvivoEditor-Linux-Shipping \
	SurvivoEditor-Linux-Test \
	SurvivoEditor \
